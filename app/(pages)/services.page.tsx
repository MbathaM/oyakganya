  ...
  return (
    <div className="bg-white min-h-screen">
      <SEO 
        ...
        description="Comprehensive consulting services: Human Capital Management, Employment Equity Compliance, Executive Coaching, Skills Development, and Organisational Development."
      />
      ...
      <div className="bg-primary text-white py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <span className="text-accent font-bold tracking-widest uppercase text-xs block mb-4">Our Solutions</span>
          <h1 className="text-5xl font-serif font-bold mb-6">Consulting Services</h1>
          <p className="text-xl text-gray-300 max-w-2xl font-light">
            Tailored strategies for HR excellence, leadership growth, and organisational transformation.
          </p>
        </div>
      </div>
          ...
          {SERVICES.map((service, index) => (
            ...
            >
              <div className="flex-1">
                ...
                <h2 className="text-3xl md:text-4xl font-serif font-bold text-primary mb-6">{service.title}</h2>
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">{service.description}</p>
                
                <ul className="space-y-4 mb-8">
                  {service.details.map((detail: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined, i: React.Key | null | undefined) => (
      ...
      <div className="bg-slate-900 py-20 mt-20 border-t border-gray-800">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-serif font-bold text-white mb-6">Ready to Transform?</h2>
          <p className="text-gray-400 mb-10 max-w-2xl mx-auto">
            Whether you need to restructure your HR policies or develop your next generation of leaders, we are here to help.
          </p>
          <Link to="/contact" className="inline-flex items-center bg-accent hover:bg-white hover:text-primary text-primary font-bold py-4 px-10 transition-all">
